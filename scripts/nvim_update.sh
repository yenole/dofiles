...
echo Neovim v$VERSION downloading
curl -# -Lo /tmp/nvim-linux.tar.gz "https://github.com/neovim/neovim/releases/download/v$VERSION/nvim-linux-x86_64.tar.gz"
